...
class Shikoku extends StatefulWidget {
  const Shikoku({Key? key}) : super(key: key);

  @override
  _ShikokuState createState() => _ShikokuState();
}

class _ShikokuState extends State<Shikoku> {
  ...
  List<int> _prefTappedList = [1, 1, 1, 1];
  @override
